...
CREATE TABLE IF NOT EXISTS tipo_local (
    ...
    constraint pk_local_atendimento_tipo_local foreign key (local_atendimento_idlocal_atendimento) references local_atendimento (idlocal_atendimento),
    constraint pk_local_atendimento_medico_tipo_local foreign key(local_atendimento_medico_idmedico) references local_atendimento (medico_idmedico)) engine= InnoDB;
...
CREATE TABLE IF NOT EXISTS local_atendimento (
    ...
    cnpj int not null,
    telefone varchar(10),
    primary key (idlocal_atendimento,medico_idmedico))engine= InnoDB;
   
   ALTER TABLE bos_covid19.local_atendimento 
   add constraint pk_medico_local_atendim 
...
ALTER TABLE bos_covid19.endereco add constraint pk_paciente_endereco foreign key (paciente_idpaciente) references bos_covid19.paciente(idpaciente);
 ...
 ALTER TABLE bos_covid19.endereco add constraint pk_local_atendimento_medico_endereco foreign key (local_atendimento_medico_idmedico) references bos_covid19.local_atendimento (medico_idmedico);   
...
CREATE TABLE IF NOT EXISTS prontuario (
 ...
 ALTER TABLE bos_covid19.prontuario add constraint pk_paciente_local_atendimento_medico_prontuario foreign key (paciente_local_atendimento_medico_idmedico) references bos_covid19.local_atendimento (medico_idmedico);
...
CREATE TABLE IF NOT EXISTS paciente (
 ...
 ALTER TABLE bos_covid19.paciente add constraint pk_paciente_local_atendimento_medico_paciente foreign key (local_atendimento_medico_idmedico) references bos_covid19.local_atendimento (medico_idmedico);
...
# ALTER TABLE local_atendimento add primary key (idlocal_atendimento,medico_idmedico);
